...
class TestGenerationService:
    ...
    def test_generate_answer(self, mock_completion, service):
    ...
    @patch("src.app.services.generation.completion")
    def test_generate_answer_custom_params(self, mock_completion, mock_config):
    ...
    def test_generate_answer_key_error(self, mock_config):
